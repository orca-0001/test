...
/**
  ...
  * @note     (*) HSI_VALUE is a constant defined in TW32f0xx_hal_conf.h file (default value
  *               16 MHz) but the real value may vary depending on the variations
  *               in voltage and temperature.
  * @note     (**) HSE_VALUE is a constant defined in TW32f0xx_hal_conf.h file (default value
  *                8 MHz), user has to ensure that HSE_VALUE is same as the real
  *                frequency of the crystal used. Otherwise, this function may
  *                have wrong result.
  * @note     (***) LSE_VALUE is a constant defined in TW32f0xx_hal_conf.h file (default value
  *               32768 Hz).
  * @note     (****) LSI_VALUE is a constant defined in TW32f0xx_hal_conf.h file (default value
  *               32000 Hz).
  *
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef  *RCC_OscInitStruct)
{
  ...
  RCC_OscInitStruct->HSEFreq = (RCC->CR & RCC_ECSCR_HSE_FREQ);
...
{
	uint32_t hsifs;
  const uint32_t hsiFreqTable[8] = {4000000,8000000,16000000,22120000,24000000,4000000,4000000,4000000};
